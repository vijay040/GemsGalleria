...
import gemsgalleria.radiantwebtech.com.gemsgalleria.model.HallmarkCertified;
import gemsgalleria.radiantwebtech.com.gemsgalleria.model.PurityOfMetal;

/**
 * Created by aphroecs on 12/2/2016.
 */
public class HallmarkFilterAdaptor extends BaseAdapter {

    ArrayList<HallmarkCertified> list;
    Activity context;

    public HallmarkFilterAdaptor(Activity context, ArrayList<HallmarkCertified> list) {
        this.list = list;
