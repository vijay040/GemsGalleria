...
import gemsgalleria.radiantwebtech.com.gemsgalleria.model.MetalType;
import gemsgalleria.radiantwebtech.com.gemsgalleria.model.PurityOfMetal;

/**
 * Created by aphroecs on 12/2/2016.
 */
public class MetalTypeFilterAdaptor extends BaseAdapter {

    ArrayList<MetalType> list;
    Activity context;

    public MetalTypeFilterAdaptor(Activity context, ArrayList<MetalType> list) {
        this.list = list;
