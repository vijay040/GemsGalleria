...
import gemsgalleria.radiantwebtech.com.gemsgalleria.model.Rhodiumcolor;

/**
 * Created by aphroecs on 12/2/2016.
 */
public class RhodiumColorFilterAdaptor extends BaseAdapter {

    ArrayList<Rhodiumcolor> list;
    Activity context;

    public RhodiumColorFilterAdaptor(Activity context, ArrayList<Rhodiumcolor> list) {
        this.list = list;
